...
import wizrole.hoservice.adapter.SerachDiseasetAdapter;
...
public class ShowDisSearchActivity extends BaseActivity {
    ...
    public DiseasInfor searchDis;
    public List<DiseaseName> diseaseNames;
    public SerachDiseasetAdapter adapter;
    public void getData(String msg,int page){
        JSONObject object=new JSONObject();
        try {
            object.put("TradeCode","Y127");
            ...
            RxJavaOkPotting.getInstance(RxJavaOkPotting.getBase_url()).Ask(RxJavaOkPotting.getBase_url(), object.toString(), new Subscriber() {
                ...
                public void onNext(Object o) {
                    if(o.equals(RxJavaOkPotting.NET_ERR)){
                        ...
                        searchDis=new DiseasInfor();
                        Gson gson=new Gson();
                        searchDis=gson.fromJson(o.toString(),DiseasInfor.class);
                        //搜索结果
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what==0){//断网
                ...
                if(page==1){
                    ...
                    ImageLoading.common(ShowDisSearchActivity.this,R.drawable.net_err,img_net_err,R.drawable.net_err);
                ...
                list_dis.setVisibility(View.INVISIBLE);
                lin_wifi_err.setVisibility(View.VISIBLE);
                ImageLoading.common(ShowDisSearchActivity.this,R.drawable.null_data,img_net_err,R.drawable.null_data);
                text_no_data.setVisibility(View.VISIBLE);
                ...
                diseaseNames=searchDis.getDiseaseName();
                totalNum=searchDis.getTotalNum();
                if(page==1){//加载第一页
                    final_list=diseaseNames;
                    adapter=new SerachDiseasetAdapter(ShowDisSearchActivity.this,diseaseNames,R.layout.list_item_search);
    ...
    protected void setListener() {
        ...
        list_dis.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                DiseaseName intrduce=final_list.get(position);
                Intent intent=new Intent(ShowDisSearchActivity.this,DiseaseDetailInforActivity.class);
