...
public class StoreListVPAdapter extends PagerAdapter {


    private List<String> url;
    private Context mContext;
    public StoreListVPAdapter(Context context, List<String> url) {
        mContext = context;
        this.url = url;
    }
...
//                ImageLoading.common(mContext, Constant.ip+url.get(position),imageView, R.drawable.mv_one);
//            }
//        }
...
//        releaseImageViewResouce(imageView);
    ...
    class onClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ToastUtil.MyToast(MyApplication.getContextObject(),"广告位火热招商中...");
        }
    }
