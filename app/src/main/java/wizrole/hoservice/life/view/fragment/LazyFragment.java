...
//                View view_load_header=LayoutInflater.from(MyApplication.getContextObject()).inflate(R.layout.merchants_load_header_view,null);
//                LinearLayout.LayoutParams params=new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.MATCH_PARENT);
//                view_load_header.setLayoutParams(params);
//                LoadingView loadingView=(LoadingView)view_load_header.findViewById(R.id.loadView);
...
//                layout.addView(view_load_header);
