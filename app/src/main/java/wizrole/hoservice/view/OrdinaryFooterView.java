...
public class OrdinaryFooterView extends LinearLayout implements RefreshFooter{
    public OrdinaryFooterView(Context context) {
        super(context);
        initView(context);
    }

    public OrdinaryFooterView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }

    public OrdinaryFooterView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
