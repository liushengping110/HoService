...
public class OrdinaryHeaderView extends LinearLayout implements RefreshHeader {
    ...
    public OrdinaryHeaderView(Context context) {
        super(context);
        initView(context);
    }

    public OrdinaryHeaderView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }

    public OrdinaryHeaderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
