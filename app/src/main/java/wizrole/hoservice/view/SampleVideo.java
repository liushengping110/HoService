...
public class SampleVideo extends StandardGSYVideoPlayer {
    ...
    private List<VedioList> mUrlList = new ArrayList<VedioList>();
    //记住切换数据源类型
    private int mType = 0;
     ...
     * @return
     */
    public boolean setUp(List<VedioList> url, boolean cacheWithPlay, String title) {
        mUrlList = url;
        return setUp(url.get(mSourcePosition).getVedioUrl(), cacheWithPlay, title);
    }
     ...
     * @return
     */
    public boolean setUp(List<VedioList> url, boolean cacheWithPlay, File cachePath, String title) {
        mUrlList = url;
        return setUp(url.get(mSourcePosition).getVedioUrl(), cacheWithPlay, cachePath, title);
    }
